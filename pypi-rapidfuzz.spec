...
Source0  : https://files.pythonhosted.org/packages/15/e5/2ab8375be6955aff1925b69c41429cbe54e32a67461c0b59f94c9b8b1cc5/rapidfuzz-2.13.7.tar.gz
...
%prep
%setup -q -n rapidfuzz-2.13.7
cd %{_builddir}/rapidfuzz-2.13.7
pushd ..
cp -a rapidfuzz-2.13.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671643109
