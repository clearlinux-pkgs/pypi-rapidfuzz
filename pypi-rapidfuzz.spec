...
Source0  : https://files.pythonhosted.org/packages/cc/42/f3bde4d6e5711b5ba266dc66c66bc0659e7c2f2016f46d1927c76d40ad57/rapidfuzz-2.13.6.tar.gz
...
%prep
%setup -q -n rapidfuzz-2.13.6
cd %{_builddir}/rapidfuzz-2.13.6
pushd ..
cp -a rapidfuzz-2.13.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670883889
