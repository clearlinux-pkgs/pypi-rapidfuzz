...
Source0  : https://files.pythonhosted.org/packages/a2/ce/7e127c2216bfcca8b3bc3cfd0075caf106f130a5068164f07a56d07cc091/rapidfuzz-3.9.4.tar.gz
...
%prep
%setup -q -n rapidfuzz-3.9.4
cd %{_builddir}/rapidfuzz-3.9.4
pushd ..
cp -a rapidfuzz-3.9.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720050075
