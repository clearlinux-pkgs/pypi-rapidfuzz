...
Source0  : https://files.pythonhosted.org/packages/11/7c/36511ff0e2e5f6cce4e854dfc1974a1519929214a38a165322f38dd01a19/rapidfuzz-3.6.2.tar.gz
...
%prep
%setup -q -n rapidfuzz-3.6.2
cd %{_builddir}/rapidfuzz-3.6.2
pushd ..
cp -a rapidfuzz-3.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709740985
