...
Source0  : https://files.pythonhosted.org/packages/01/8c/cad170708243488e2b2a2e727eb40f30018231efa7fa1a9a3a3dc82d9f42/rapidfuzz-2.15.0.tar.gz
...
%prep
%setup -q -n rapidfuzz-2.15.0
cd %{_builddir}/rapidfuzz-2.15.0
pushd ..
cp -a rapidfuzz-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680533492
