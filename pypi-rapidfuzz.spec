...
Source0  : https://files.pythonhosted.org/packages/50/b9/22b4848fc842b17c4446433d5d472007c9799dbe8dd90bc0f6d60767c29d/rapidfuzz-3.9.3.tar.gz
...
%prep
%setup -q -n rapidfuzz-3.9.3
cd %{_builddir}/rapidfuzz-3.9.3
pushd ..
cp -a rapidfuzz-3.9.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717433232
