...
Source0  : https://files.pythonhosted.org/packages/57/93/8a975f8462fadffd1b608a1a5df2bb9feea569e5bcef5a6abfb154853e24/rapidfuzz-2.13.3.tar.gz
...
%prep
%setup -q -n rapidfuzz-2.13.3
cd %{_builddir}/rapidfuzz-2.13.3
pushd ..
cp -a rapidfuzz-2.13.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670498812
