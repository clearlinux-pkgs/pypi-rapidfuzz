...
Source0  : https://files.pythonhosted.org/packages/7a/85/b880d556130d19ac415bfaf1af9406263f7597b5b7ba062db1f532e587b9/rapidfuzz-2.13.2.tar.gz
Summary  : rapid fuzzy string matching
Group    : Development/Tools
License  : MIT
Requires: pypi-rapidfuzz-filemap = %{version}-%{release}
Requires: pypi-rapidfuzz-lib = %{version}-%{release}
...
%package filemap
Summary: filemap components for the pypi-rapidfuzz package.
Group: Default

%description filemap
filemap components for the pypi-rapidfuzz package.


%package lib
Summary: lib components for the pypi-rapidfuzz package.
Group: Libraries
Requires: pypi-rapidfuzz-license = %{version}-%{release}
Requires: pypi-rapidfuzz-filemap = %{version}-%{release}

%description lib
lib components for the pypi-rapidfuzz package.
...
%prep
%setup -q -n rapidfuzz-2.13.2
cd %{_builddir}/rapidfuzz-2.13.2
pushd ..
cp -a rapidfuzz-2.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669222766
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-pypi-rapidfuzz
